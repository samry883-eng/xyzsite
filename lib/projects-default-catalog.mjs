/**
 * Canonical work rows + helpers to build the default projects catalog.
 * Seed source: Work/unified/index.html + credits from generate-projects.mjs
 */
import { categorySlug, SERVICE_OPTIONS, PROJECT_TYPES, sortServices, resolveProjectCredits, projectHref } from './projects-store.mjs';
...
export const THUMBNAILS = {
  ...
  'f1 2026 launch film|audi': '/work/sound/f1-2026-launch-film/poster.jpg',
  'knwls|knwls': '/work/sound/knwls/poster.jpg',
  'wavs|wavs': '/work/sound/wavs/poster.jpg',
  'raid shadow legends|raid': '/work/visual-effects/raid-shadow-legends/poster.jpg',
  'after every man jack|john deere': '/work/sound/after-every-man-jack/poster.jpg',
  'ariana grande|swarovski': '/work/sound/swarovski-ariana-grande/poster.jpg',
};
...
export const ROWS = [
  {
    ...
    cards: [
      { video: SB + 'QXPhjJBFtd/original', client: 'NBA', title: '2026 Finals', slug: '2026-finals', projectType: 'Brand Film', credits: [{ label: 'Directed by', value: 'Dris Yousif' }, { label: 'Produced by', value: 'XYZ Studios' }], services: ['Creative Direction', 'CGI', 'Sound Design', 'Mixing & Mastering'] },
      { video: VF + 'cbf82991-c743-4045-8898-b6ee78efd9b4.mp4', client: 'Atomic', title: 'Into the Void', clipStart: 24, clipEnd: 33, credits: [{ label: 'Directed by', value: 'Dris Yousif' }, { label: 'Produced by', value: 'XYZ Studios' }], services: ['Creative Direction', 'Visual Effects', 'CGI', 'Compositing', 'Sound Design', 'Mixing & Mastering', 'Compose'] },
      { video: VF + 'd93de57b-6909-4f1e-81d3-8d1f6252c2f7.mp4', client: 'Nike', title: 'France World Cup', slug: 'france-world-cup', poster: '/work/visual-effects/france-world-cup/poster.jpg', credits: [{ label: 'Directed by', value: 'Alexis Belhumeur' }, { label: 'Agency', value: 'Knas' }], services: ['Visual Effects', 'Compositing', 'AI'] },
      { video: VF + 'af62bf83-f2c4-4ff5-ae90-e056d209eaae.mp4', client: 'Cara Delevingne', title: 'I Forgot & Out of My Head', poster: '/work/visual-effects/i-forgot-out-of-my-head/poster.jpg', credits: [{ label: 'Directed by', value: 'Jessica Le Gagne' }, { label: 'Production Company', value: 'Reset Content' }] },
      { video: VF + 'ef1dc602-5a95-4973-a0ea-82794726bc4a.mp4', client: 'Salomon', title: 'Speedcross 3', credits: [{ label: 'Directed by', value: 'Lenn Anton' }, { label: 'Produced by', value: 'XYZ Studios' }], services: ['Visual Effects', 'CGI', 'Compositing', 'Sound Design', 'Mixing & Mastering', 'Clean Up & Beauty'] },
      ...
      { video: SB + '85D_It6HUS/original', client: 'RBC', title: 'Canadian Open', credits: [{ label: 'Agency', value: 'Wasserman' }, { label: 'Produced by', value: 'XYZ Studios' }], services: ['Creative Direction', 'Visual Effects', 'CGI', 'Compositing', 'Clean Up & Beauty', 'Sound Design'] },
      { video: SB + 'JchEHAr96O/original', client: 'JennAir', title: 'The Flip', credits: [{ label: 'Directed by', value: 'Nick Martini' }, { label: 'Production', value: 'Stept Studios' }], services: ['Visual Effects', 'CGI', 'Compositing'] },
      { video: SB + '0yJ5A9ii2H/original', client: 'Fanatics', title: 'NBA Store', credits: [{ label: 'Directed by', value: 'Jimmy Derner' }, { label: 'Production Company', value: 'Wolfpak Films' }], services: ['Compositing', 'Clean Up & Beauty'] },
      { video: SB + 'mu8ewXP3uH/original', client: 'Fanatics', title: 'NHL Store', credits: [{ label: 'Directed by', value: 'Jimmy Derner' }, { label: 'Production Company', value: 'Wolfpak Films' }], services: ['Compositing', 'CGI', 'Clean Up & Beauty'] },
      { video: VF + 'edac671a-7d48-4eb1-b1ea-c2556b330ee4.mp4', client: 'Chino Pacas', title: 'Modo Capone ft. Drake', credits: [{ label: 'Directed by', value: 'Chris Villa' }, { label: 'Production Company', value: 'SHOTCLOCK' }], services: ['Visual Effects', 'Compositing', 'CGI'] },
      ...
      { video: SB + '2tB97EuJPD/original', client: 'Puma', title: 'Kid Super', slug: 'kid-super' },
      { video: VF + 'eba40295-a63b-45a1-a80d-3324f0b6c750.mp4', client: 'Raid', title: 'Raid Shadow Legends', slug: 'raid-shadow-legends', poster: '/work/visual-effects/raid-shadow-legends/poster.jpg' },
    ],
  },
  {
    label: 'Sound',
    cards: [
      ...
      { video: VF + '7c584065-5afb-43e4-9b67-ef1b5b6db304.mp4', client: 'Audi', title: 'F1 2026 Launch Film', slug: 'f1-2026-launch-film', poster: '/work/sound/f1-2026-launch-film/poster.jpg', credits: [{ label: 'Directed by', value: 'XYZ Studios' }, { label: 'Produced by', value: 'XYZ Studios' }] },
      ...
      { video: VF + '8bdede9c-3055-4065-a194-3f620e6d4f3b.mp4', client: 'Celsius', title: 'Spritez Vibez', poster: '/work/sound/spritez-vibez/poster.jpg', services: ['Sound Design', 'Clean Up & Beauty'] },
      { video: VF + '9d988956-2525-48f8-8191-0d028e9493dd.mp4', client: 'Wavs', title: 'Wavs', slug: 'wavs', poster: '/work/sound/wavs/poster.jpg' },
      { video: VF + 'acddd408-ce03-4c91-a53f-bb3e6f83dafe.mp4', client: 'TBD', title: 'Wrapped in Heat' },
      { video: VF + '0ebab23b-0659-4385-873a-8a4b6eecb0d8.mp4', client: 'War Ready', title: 'War Ready Official Album Trailer' },
      { video: VF + '59722a46-21f4-43c9-a22c-8e25f399a20b.mp4', client: 'Wham', title: 'Wham Trailer' },
      { video: VF + '1b4f1208-57d6-4cc8-a828-b4e005070c8d.mp4', client: 'Wingstop', title: 'Wingstop' },
      { video: VF + 'f847ef63-1a1f-470c-af9d-88555f8cd7b5.mp4', client: 'KNWLS', title: 'Knwls', slug: 'knwls', poster: '/work/sound/knwls/poster.jpg' },
      { video: VF + '5fb6c412-713f-4257-bd4c-d3ad16b8ff6f.mp4', client: 'John Deere', title: 'After Every Man Jack', slug: 'after-every-man-jack', poster: '/work/sound/after-every-man-jack/poster.jpg' },
      { video: VF + 'ebf0a35a-8d8f-41f6-840b-982d5c05e3e3.mp4', client: 'Swarovski', title: 'Ariana Grande', slug: 'swarovski-ariana-grande', poster: '/work/sound/swarovski-ariana-grande/poster.jpg' },
    ],
  },
  {
    label: 'AI',
...
function projectURL(card, catLabel) {
  ...
  return projectHref(categorySlug(catLabel), slug);
}

function getPoster(card, catLabel) {
  if (card.poster) return card.poster;
  const key = normalizeKey(card.title, card.client);
  if (THUMBNAILS[key]) return THUMBNAILS[key];
  const slug = card.slug || slugify(card.title);
  return expectedPosterPath(categorySlug(catLabel), slug);
}

function cardCredits(card) {
  return resolveProjectCredits(card, { applyDefaults: true });
}
...
export function inferProjectMeta(card, catLabel) {
  ...
  } else if (/manifesto|teaser|trailer|good sports|ai awareness|compromise|precision|galaxy|join the search|hard is home|stay in rotation|the hunt|style is in session|spritez|sous la lune|imagine|cold wall|open|beats|louis vuitton|prime video|arc|wingstop|raid shadow|2026 finals/i.test(blob)) {
  ...
  return {
    services: sortServices(Array.from(services).filter((s) => SERVICE_OPTIONS.includes(s))),
    projectType: PROJECT_TYPES.includes(projectType) ? projectType : 'Commercial',
  };
}

function projectHasCredits(p) {
  return Array.isArray(p.credits) && p.credits.some((c) => c && c.label && c.value);
}

/** First 8 hex chars of an r2.vidzflow.com/source/{uuid}.mp4 URL, or null. */
function r2SourcePrefix(url) {
  if (!url || typeof url !== 'string') return null;
  const m = url.match(/r2\.vidzflow\.com\/source\/([0-9a-f]{8})/i);
  return m ? m[1].toLowerCase() : null;
}

/** Repair corrupted r2 URLs that still reference the same asset id prefix as the default catalog. */
function shouldRepairVideo(storedVideo, defaultVideo) {
  if (!defaultVideo || !storedVideo || storedVideo === defaultVideo) return false;
  const storedPrefix = r2SourcePrefix(storedVideo);
  const defaultPrefix = r2SourcePrefix(defaultVideo);
  return !!(storedPrefix && defaultPrefix && storedPrefix === defaultPrefix);
}

/** Fill only empty/missing fields on an existing Redis project — never overwrite admin edits. */
function fillMissingProjectFields(p, def) {
  let repaired = 0;
  if (!p.slug && def.slug) { p.slug = def.slug; repaired++; }
  if (!p.category && def.category) { p.category = def.category; repaired++; }
  if (def.video && !p.video) {
    p.video = def.video;
    repaired++;
  } else if (def.video && p.video && shouldRepairVideo(p.video, def.video)) {
    p.video = def.video;
    repaired++;
  }
  if (!p.projectType && def.projectType) { p.projectType = def.projectType; repaired++; }
  if (!Object.prototype.hasOwnProperty.call(p, 'services') && def.services?.length) {
    p.services = def.services;
    repaired++;
  }
  if (def.poster && (!p.poster || isGenericPoster(p.poster))) {
    p.poster = def.poster;
    repaired++;
  }
  if (!p.href && p.category && p.slug) {
    p.href = '/work/' + p.category + '/' + p.slug + '/';
    repaired++;
  }
  if (Object.prototype.hasOwnProperty.call(p, 'credits')) return repaired;
  const resolved = resolveProjectCredits({ ...def, ...p }, { applyDefaults: true });
  if (resolved.length) {
    p.credits = resolved;
    repaired++;
  }
...
/** Fill empty/missing fields on stored projects from defaults — never add or remove rows. */
export function repairCatalogFromDefaults(catalog) {
  if (!catalog || !Array.isArray(catalog.projects)) {
    return { catalog, repaired: 0 };
  }
  const defaults = buildDefaultCatalog();
  const defaultById = new Map(defaults.projects.map((p) => [p.id, p]));
  let repaired = 0;
  catalog.projects.forEach((p) => {
    const def = defaultById.get(p.id);
    if (!def) return;
    repaired += fillMissingProjectFields(p, def);
  });
  return { catalog: { version: catalog.version || 1, projects: catalog.projects }, repaired };
}
...
export function mergeDefaultCatalogMissing(catalog) {
  if (!catalog || !Array.isArray(catalog.projects)) {
    return { catalog: buildDefaultCatalog(), added: buildDefaultCatalog().projects.length, repaired: 0 };
  }
  const { catalog: repairedCatalog, repaired } = repairCatalogFromDefaults(catalog);
  const defaults = buildDefaultCatalog();
  const existingIds = new Set(repairedCatalog.projects.map((p) => p.id));
  let added = 0;
  defaults.projects.forEach((p) => {
    if (existingIds.has(p.id)) return;
    repairedCatalog.projects.push({ ...p, sortOrder: repairedCatalog.projects.length });
    existingIds.add(p.id);
    added++;
  });
  return { catalog: { version: repairedCatalog.version || 1, projects: repairedCatalog.projects }, added, repaired };
}
  ...
  ROWS.forEach((row) => {
    ...
    row.cards.forEach((card) => {
      ...
      projects.push({
        ...
        video: card.video,
        poster: getPoster(card, row.label),
        credits: cardCredits(card),
        services: card.services?.length
          ? sortServices(card.services.filter((s) => SERVICE_OPTIONS.includes(s)))
          : meta.services,
        projectType: PROJECT_TYPES.includes(card.projectType) ? card.projectType : meta.projectType,
