...
export function inferProjectMeta(card, catLabel) {
  ...
  } else if (/manifesto|teaser|trailer|good sports|ai awareness|compromise|precision|galaxy|join the search|hard is home|stay in rotation|the hunt|style is in session|spritez|sous la lune|imagine|cold wall|open|beats|louis vuitton|prime video|arc|wingstop|raid shadow/i.test(blob)) {
