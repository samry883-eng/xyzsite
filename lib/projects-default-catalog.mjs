 ...
 */
import { categorySlug, SERVICE_OPTIONS, PROJECT_TYPES, sortServices, resolveProjectCredits } from './projects-store.mjs';
...
export const ROWS = [
  {
    ...
    cards: [
      ...
      { video: VF + 'eba40295-a63b-45a1-a80d-3324f0b6c750.mp4', client: 'Raid', title: 'Raid Shadow Legends' },
    ],
  },
  {
    label: 'Sound',
    cards: [
      ...
      { video: VF + '9d988956-2525-48f8-8191-0d028e9493dd.mp4', client: 'Add Wavs', title: 'Add Wavs' },
...
export function mergeDefaultCatalogMissing(catalog) {
  ...
  return { catalog: { version: catalog.version || 1, projects: catalog.projects }, added, repaired };
}
